...
<div class="navbar">
  <div class="navbar-inner">
    <div class="container"> <a class="brand" href="/">PHP + Slim Framework + MySQL + jQuery REST APIs</a> </div>
  </div>
</div>
<div class="container">
  <ul class="breadcrumb">
    <li><a href="/php_rest/">Home</a> <span class="divider">/</span></li>
    <li class="active">Edit/Update<span class="divider">/</span></li>
	<li><div id="msg" class="alert" style="display:none;"></div></li>
  </ul>
  <div class="row">
    <div class="span12">
      <form action="sendStat" method="POST" id="edit-form" class="form-horizontal">
        <div class="control-group">
          <label for="username" class="control-label">Username</label>
          <div class="controls">
            <input name="username" id="username" type="text" value="<?=$r['username'];?>" />
          </div>
        </div>
        <div class="control-group">
          <label for="stat_name" class="control-label">Stat name</label>
          <div class="controls">
            <input name="stat_name" id="stat_name" type="text" value="<?=$r['stat_name'];?>" />
          </div>
        </div>
        <div class="control-group">
          <label for="stat_value" class="control-label">Stat value</label>
          <div class="controls">
            <input name="stat_value" id="stat_value" type="text" value="<?=$r['stat_value'];?>" />
          </div>
        </div>
        <div class="form-actions">
          <button type="submit" class="btn btn-primary"><i class="icon-ok icon-white"></i> Update rest</button>
